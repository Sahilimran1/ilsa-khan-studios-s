...
// Home page: scroll-triggered horizontal gallery movement
function initHomeScrollGallery(){
  ...
  function update(){
    ...
    const maxMove = Math.max(track.scrollWidth - window.innerWidth + window.innerWidth * 0.16, 0);
    const eased = 1 - Math.pow(1 - progress, 3);
    track.style.transform = `translate3d(${-maxMove * eased}px,0,0)`;
  }
